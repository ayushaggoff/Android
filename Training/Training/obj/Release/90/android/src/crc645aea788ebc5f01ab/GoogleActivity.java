...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Training.Activity.GoogleActivity, Training", GoogleActivity.class, __md_methods);
	}
	...
	public GoogleActivity ()
	{
		...
		if (getClass () == GoogleActivity.class)
			mono.android.TypeManager.Activate ("Training.Activity.GoogleActivity, Training", "", this, new java.lang.Object[] {  });
	}
